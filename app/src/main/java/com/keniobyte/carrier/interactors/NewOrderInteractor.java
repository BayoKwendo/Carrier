...
import com.keniobyte.carrier.helperclasses.DirectionsJSONParser;
import com.keniobyte.carrier.helperclasses.FirebaseOpsHelper;
import com.keniobyte.carrier.items.NewOrder;
import com.keniobyte.carrier.presenters.NewOrderPresenter;
...
//        }
    ...
    private LatLngBounds getDefaultBounds() {
        return new LatLngBounds(new LatLng(52.22843, 17.27617),
                new LatLng(52.61201, 16.57794));
    }
